...
INSERT INTO "new_channels" ("avatar", "chat_id", "id", "invite_code", "is_public", "name", "owner_id") SELECT "avatar", "chat_id", "id", "invite_code", "is_public", "name", "owner_id" FROM "channels";
DROP TABLE "channels";
