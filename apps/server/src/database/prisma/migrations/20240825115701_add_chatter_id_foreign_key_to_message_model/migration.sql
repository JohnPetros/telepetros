/*
  ...
  - Added the required column `chatter_id` to the `messages` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_messages" ("chat_id", "created_at", "id", "parent_message_id", "type", "value") SELECT "chat_id", "created_at", "id", "parent_message_id", "type", "value" FROM "messages";
DROP TABLE "messages";
